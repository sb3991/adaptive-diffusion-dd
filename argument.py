...
elif args.subset == "imagenet-sketch":
    args.nclass = 1000
    args.classes = range(args.nclass)
    args.val_ipc = 10
    args.input_size = 224

elif args.subset == "imagenet-r":
    args.nclass = 200
    args.classes = range(args.nclass)
    args.val_ipc = 10
    args.input_size = 224
...
args.exp_name = f"{args.subset}_{args.arch_name}_stud{args.stud_name}_f{args.factor}_mipc{args.mipc}_cr{args.num_crop}_str{args.strength_lb}-{args.strength_ub}_cfg{args.cfg_lb}-{args.cfg_ub}--init_{args.init_points}_iter_{args.n_iter}_lambda_{args.lam}"
